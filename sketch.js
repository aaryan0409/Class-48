/*In the level1, obstacles will be moving and the player has to reach the treasure without touching the 
obstacles and edges.
In the level2, the player has to jump over the hurdles and reach the treasure without falling
on the red area.
In level3, the lasers will be moving and the player has to reach the treasure 
without touching the lasers.
Death means that a player will have 3 lives per level.
*/
var player,treasure,treasure2;
var boyimg,bgimg,brickimg,treasureimg,level2img,gameoverimg,groupimg,youwonimg;
var block1,block2;
...
var platform1,platform2,youwon;
var death=3;
var gameState="play";
var obstacleGroup;
var level2,level3;
...
function setup() {
  ...
  laser1=createSprite(200,300,400,20);
  laser1.visible=false;
  laser1.shapeColor="red";
  laser1.velocityY=-5;
  laser2=createSprite(600,400,400,20);
  ...
  youwon=createSprite(400,300,30,30);
...
function draw() {
  ...
  if(mousePressedOver(level2)&&gameState==="play"){
    level2.destroy();
    gameState="level2";
  }
  ...
  if(player.isTouching(treasure2)&&gameState==="level2play"){
   ...
   if(mousePressedOver(level3)&&gameState==="level3"){
 ...
 if(gameState==="level3play"){    
  ...
  if(gameState==="level3play"){
    ...
    treasure2.x=750;
    treasure2.y=50;
    gameState="level3main";
  }

  if(gameState==="level3main"){
  ...
  if(laser1.collide(edges[2])){
    laser1.velocityY=5;
  }

  if(laser2.collide(edges[3])){
    laser2.velocityY=-5;
  }
